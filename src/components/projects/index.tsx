...
import { Projects } from './component/animation';
...
export default function Project() {
    ...
    const manageModal = (active: any, index: number, x: number, y: number) => {
      moveItems(x, y)
        ...
        <div className={styles.body}>
          {
            projects.map( (project, index) => {
              return <Projects index={index} title={project.title} manageModal={manageModal} key={index}/>
            })
          }
        </div>
        <>
